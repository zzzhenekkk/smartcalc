...
START_TEST(sub_1_test) {
  s21_smartcalc num1 = {{5, 4, 3, 0}};
  s21_smartcalc num2 = {{3, 1, 2, 0}};
...
START_TEST(sub_2_test) {
  s21_smartcalc num1 = {{(unsigned int)-1, (unsigned int)-1, (unsigned int)-1688,
                       (unsigned int)-2147483648}};
  s21_smartcalc num2 = {{44, 369, 1687, 0}};
  s21_smartcalc res = {{0, 0, 0, 0}};
  //     print_smartcalc(num1);
  // print_smartcalc(num2);
  // printf("\n!!!!!!!!\n");
  int status = s21_sub(num1, num2, &res);
  //   s21_smartcalc res2 = {{(unsigned int)43, (unsigned int)369, (unsigned
...
START_TEST(sub_3_test) {
  s21_smartcalc num1 = {{10, 11, 12, (unsigned int)-2147483648}};
  s21_smartcalc num2 = {{11, 13, 15, (unsigned int)-2147483648}};
  s21_smartcalc res = {{0, 0, 0, 0}};
  int status = s21_sub(num1, num2, &res);
  ck_assert_int_eq(status, 0);
...
START_TEST(sub_4_test) {
  ...
  s21_smartcalc num2 = {{44, 369, 1687, (unsigned int)-2147483648}};
  s21_smartcalc res = {{0, 0, 0, 0}};
  //   print_smartcalc(num1);
  // print_smartcalc(num2);
  // printf("\n!!!!!!!!\n");
...
START_TEST(sub_5_test) {
  s21_smartcalc num1 = {{45, 0, 10, (unsigned int)-2147483648}};
  s21_smartcalc num2 = {{67, 0, 1, (unsigned int)-2147352576}};
  s21_smartcalc res = {{0, 0, 0, 0}};
  int status = s21_sub(num1, num2, &res);
  ck_assert_int_eq(status, 0);
...
START_TEST(sub_6_test) {
  s21_smartcalc num1 = {{45, 0, 10, 65536}};
  s21_smartcalc num2 = {{67, 0, 0, 131072}};
  s21_smartcalc res = {{0, 0, 0, 0}};
  int status = s21_sub(num1, num2, &res);
  ck_assert_int_eq(status, 0);
...
START_TEST(sub_7_test) {
  ...
  s21_smartcalc num2 = {{5, 0, 0, 65536}};
  s21_smartcalc res = {{0, 0, 0, 0}};
  //     print_smartcalc(num1);
  // print_smartcalc(num2);
  // printf("\n!!!!!!!!\n");
  int status = s21_sub(num1, num2, &res);
  //       s21_smartcalc res2 = {{(unsigned int)-3, (unsigned int)-1, (unsigned
  //       int)-1, 0}};
  // printf("\n!!!!!!!!\n");
...
START_TEST(sub_8_test) {
  s21_smartcalc num1 = {{(unsigned int)-3, (unsigned int)-1, (unsigned int)-1,
                       (unsigned int)-2147483648}};
  s21_smartcalc num2 = {{7, 0, 0, (unsigned int)-2147418112}};
  s21_smartcalc res = {{2, 1, 4, 65536}};
  int status = s21_sub(num1, num2, &res);
  ck_assert_int_eq(status, 0);
...
START_TEST(sub_9_test) {
  s21_smartcalc num1 = {{0, 0, 10, 0}};
  s21_smartcalc num2 = {{6, 0, 0, 589824}};
  s21_smartcalc res = {{0, 0, 0, 0}};
  int status = s21_sub(num1, num2, &res);
  ck_assert_int_eq(status, 0);
...
START_TEST(sub_10_test) {
  s21_smartcalc num1 = {{0, 0, 13, (unsigned int)-2147483648}};
  s21_smartcalc num2 = {{4, 0, 0, (unsigned int)-2146893824}};
  s21_smartcalc res = {{0, 0, 0, 0}};
  int status = s21_sub(num1, num2, &res);
  ck_assert_int_eq(status, 0);
  ck_assert_int_eq(res.bits[0], 0);
...
START_TEST(sub_11_test) {
  s21_smartcalc num1 = {{6, 7, 8, 0}};
  s21_smartcalc num2 = {{5, 4, 3, (unsigned int)-2147483648}};
  s21_smartcalc res = {{0, 0, 0, 0}};
  int status = s21_sub(num1, num2, &res);
  ck_assert_int_eq(status, 0);
...
START_TEST(sub_12_test) {
  s21_smartcalc num1 = {{3, 1, 3, 0}};
  s21_smartcalc num2 = {{5, 4, 8, (unsigned int)-2147483648}};
  s21_smartcalc res = {{0, 0, 0, 0}};
  int status = s21_sub(num1, num2, &res);
  ck_assert_int_eq(status, 0);
...
START_TEST(sub_13_test) {
  s21_smartcalc num1 = {{6, 7, 8, (unsigned int)-2147483648}};
  s21_smartcalc num2 = {{5, 4, 3, 0}};
  s21_smartcalc res = {{0, 0, 0, 0}};
  int status = s21_sub(num1, num2, &res);
  ck_assert_int_eq(status, 0);
  ck_assert_int_eq(res.bits[0], 11);
...
START_TEST(sub_14_test) {
  s21_smartcalc num1 = {{3, 1, 3, (unsigned int)-2147483648}};
  s21_smartcalc num2 = {{5, 4, 8, 0}};
  s21_smartcalc res = {{0, 0, 0, 0}};
  int status = s21_sub(num1, num2, &res);
  ck_assert_int_eq(status, 0);
  ck_assert_int_eq(res.bits[0], 8);

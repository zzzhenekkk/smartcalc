...
START_TEST(mul_2x2) {
  s21_smartcalc num1 = {{2, 0, 0, 0}};
  s21_smartcalc num2 = {{2, 0, 0, 0}};
  s21_smartcalc res = {{0, 0, 0, 0}};
...
START_TEST(mul_24xminus6) {
  s21_smartcalc num1 = {{24, 0, 0, 0}};
  s21_smartcalc num2 = {{6, 0, 0, (unsigned int)-2147483648}};
  s21_smartcalc res = {{0, 0, 0, 0}};
  int status = s21_mul(num1, num2, &res);
  ck_assert_int_eq(status, 0);
...
START_TEST(mul_minus500xminus3) {
  s21_smartcalc num1 = {{500, 0, 0, (unsigned int)-2147483648}};
  s21_smartcalc num2 = {{3, 0, 0, (unsigned int)-2147483648}};
  s21_smartcalc res = {{0, 0, 0, 0}};
  int status = s21_mul(num1, num2, &res);
  ck_assert_int_eq(status, 0);
...
START_TEST(mul_minus2x5) {
  s21_smartcalc num1 = {{2, 0, 0, 0}};
  s21_smartcalc num2 = {{5, 0, 0, (unsigned int)-2147483648}};
  s21_smartcalc res = {{0, 0, 0, 0}};
  int status = s21_mul(num1, num2, &res);
  ck_assert_int_eq(status, 0);
...
START_TEST(mul_3x0point256) {
  s21_smartcalc num1 = {{3, 0, 0, 0}};
  s21_smartcalc num2 = {{256, 0, 0, 262144}};
  s21_smartcalc res = {{0, 0, 0, 0}};
  int status = s21_mul(num1, num2, &res);
  ck_assert_int_eq(status, 0);
...
START_TEST(mul_9point213658xminus169point312846) {
  s21_smartcalc num1 = {{9213658, 0, 0, 393216}};
  s21_smartcalc num2 = {{169312846, 0, 0, (unsigned int)-2147090432}};
  s21_smartcalc res = {{0, 0, 0, 0}};
  int status = s21_mul(num1, num2, &res);
  ck_assert_int_eq(status, 0);
...
START_TEST(mul_3point21x30point336) {
  s21_smartcalc num1 = {{321, 0, 0, 131072}};
  s21_smartcalc num2 = {{30336, 0, 0, 196608}};
  s21_smartcalc res = {{0, 0, 0, 0}};
  int status = s21_mul(num1, num2, &res);
  ck_assert_int_eq(status, 0);
...
START_TEST(mul_minus3point2xminus0point3) {
  s21_smartcalc num1 = {{32, 0, 0, (unsigned int)-2147418112}};
  s21_smartcalc num2 = {{3, 0, 0, (unsigned int)-2147418112}};
  s21_smartcalc res = {{0, 0, 0, 0}};
  int status = s21_mul(num1, num2, &res);
  ck_assert_int_eq(status, 0);
...
START_TEST(mul_bigXfloat) {
  s21_smartcalc num1 = {{0, 0, 1, 0}};
  s21_smartcalc num2 = {{256, 0, 0, 917504}};
  s21_smartcalc res = {{0, 0, 0, 0}};
  int status = s21_mul(num1, num2, &res);
  ck_assert_int_eq(status, 0);
  ck_assert_int_eq(res.bits[0], 0);
...
START_TEST(mul_overflow_positive) {
  s21_smartcalc num1 = {{0, 0, 5, 0}};
  s21_smartcalc num2 = {{(unsigned int)-1, 0, 0, 0}};
  s21_smartcalc res = {{0, 0, 0, 0}};
  int status = s21_mul(num1, num2, &res);
...
START_TEST(mul_overflow_negative) {
  s21_smartcalc num1 = {{0, 0, 1, 0}};
  s21_smartcalc num2 = {{0, (unsigned int)-1, 0, (unsigned int)-2147483648}};
  s21_smartcalc res = {{0, 0, 0, 0}};
  int status = s21_mul(num1, num2, &res);
...
START_TEST(mul_minusBigXminusBig) {
  s21_smartcalc num1 = {{0, 0, 1, (unsigned int)-2147483648}};
  s21_smartcalc num2 = {{0, -1, 0, (unsigned int)-2147483648}};
  s21_smartcalc res = {{0, 0, 0, 0}};
  int status = s21_mul(num1, num2, &res);
  ck_assert_int_eq(status, 1);
}
...
START_TEST(mul_normalXsmall) {
  s21_smartcalc num1 = {{200, 0, 0, 0}};
  s21_smartcalc num2 = {{2, 0, 0, 1703936}};
  s21_smartcalc res = {{0, 0, 0, 0}};
  // print_smartcalc(num1);
  // print_smartcalc(num2);
  // printf("\n!!!!!!!!\n");
  int status = s21_mul(num1, num2, &res);
  // s21_smartcalc res2 = {{(unsigned int)4, (unsigned int)0, (unsigned int)0,
  // (unsigned int)1572864}}; printf("\n!!!!!!!!\n");

  // print_smartcalc(res);
  // print_smartcalc(res2);
  ck_assert_int_eq(status, 0);
...
START_TEST(mul_floatXsmall) {
  s21_smartcalc num1 = {{41152263, 0, 0, 1048576}};
  s21_smartcalc num2 = {{3, 0, 0, 917504}};
  s21_smartcalc res = {{0, 0, 0, 0}};
  // print_smartcalc(num1);
  // print_smartcalc(num2);
  // printf("\n!!!!!!!!\n");
  int status = s21_mul(num1, num2, &res);
  //   s21_smartcalc res2 = {{(unsigned int)1234566, (unsigned int)0, (unsigned
...
START_TEST(mul_smallXsmall) {
  s21_smartcalc num1 = {{4, 0, 0, 1048576}};
  s21_smartcalc num2 = {{3, 0, 0, 1048576}};
  s21_smartcalc res = {{0, 0, 0, 0}};
  // print_smartcalc(num1);
  // print_smartcalc(num2);
  // printf("\n!!!!!!!!\n");
  int status = s21_mul(num1, num2, &res);
  //   s21_smartcalc res2 = {{(unsigned int)0, (unsigned int)0, (unsigned int)0,
  //   (unsigned int)0}};
  // printf("\n!!!!!!!!\n");
...
START_TEST(mul_bigXsmall) {
  s21_smartcalc num1 = {{0, 0, 1234000000, 393216}};
  s21_smartcalc num2 = {{1, 0, 0, 1835008}};
  s21_smartcalc res = {{0, 0, 0, 0}};
  int status = s21_mul(num1, num2, &res);
  ck_assert_int_eq(status, 0);
  ck_assert_int_eq(res.bits[0], 0);

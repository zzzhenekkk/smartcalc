...
START_TEST(test_s21_dec_to_float_003f) {
  ...
  int err = s21_from_smartcalc_to_float(result, &check);
...
START_TEST(test_s21_dec_to_float_2546_5f) {
  ...
  s21_from_smartcalc_to_float(result, &check);
  char flt2str[1000];
...
START_TEST(test_s21_dec_to_float_null_error) {
  ...
  int val = s21_from_smartcalc_to_float(test, check);

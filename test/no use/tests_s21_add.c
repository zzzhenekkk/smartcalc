...
START_TEST(add_1_test) {
  s21_smartcalc num = {{1, 0, 0, 0}};
  s21_smartcalc num2 = {{1, 0, 0, 0}};
  s21_smartcalc res = {0};
  s21_smartcalc answer = {{2, 0, 0, 0}};
...
START_TEST(add_2_test) {
  s21_smartcalc num1 = {{-1, -1, 56648, 0}};
...
START_TEST(add_6_test) {
  ...
  s21_smartcalc num2 = {{67, 0, 0, (unsigned int)-2147352576}};
...
START_TEST(add_9_test) {
  ...
  // printf("\n!!!!!!!!\n");
  int status = s21_add(num1, num2, &res);
  // s21_smartcalc res2 = {{(unsigned int)-2, (unsigned int)-1, (unsigned int)-1,

...
START_TEST(div_2_test) {
  s21_smartcalc num1 = {{10, 0, 0, 0}};
  s21_smartcalc num2 = {{4, 0, 0, (unsigned int)-2147483648}};
  s21_smartcalc res = {{0, 0, 0, 0}};
  int status = s21_div(num1, num2, &res);
  ck_assert_int_eq(status, 0);
...
START_TEST(div_4_test) {
  s21_smartcalc num1 = {{10, 0, 0, 0}};
  s21_smartcalc num2 = {{22, 0, 0, 65536}};
  s21_smartcalc res = {{0, 0, 0, 0}};
  int status = s21_div(num1, num2, &res);
  // printf("\n!!!!!!!!\n");
...
START_TEST(div_5_test) {
  s21_smartcalc num1 = {{10, 0, 0, 0}};
  s21_smartcalc num2 = {{1, 0, 0, 393216}};
  s21_smartcalc res = {{0, 0, 0, 0}};
  int status = s21_div(num1, num2, &res);
  ck_assert_int_eq(status, 0);
...
START_TEST(div_6_test) {
  s21_smartcalc num1 = {{10, 0, 0, 0}};
  s21_smartcalc num2 = {{6, 0, 0, 1835008}};
  s21_smartcalc res = {{0, 0, 0, 0}};
  int status = s21_div(num1, num2, &res);
  ck_assert_int_eq(status, 0);
...
START_TEST(div_7_test) {
  s21_smartcalc num1 = {{10, 0, 0, 0}};
  s21_smartcalc num2 = {{658067456, 1164, 0, 0}};
  s21_smartcalc res = {{0, 0, 0, 0}};
  //       print_smartcalc(num1);
  // print_smartcalc(num2);
  // printf("\n!!!!!!!!\n");
  int status = s21_div(num1, num2, &res);
  //    s21_smartcalc res2 = {{(unsigned int)2, (unsigned int)0, (unsigned int)0,
  //    (unsigned int)786432}};
  // printf("\n!!!!!!!!\n");
...
START_TEST(div_15_test) {
  s21_smartcalc num1 = {
      {(unsigned int)-1, (unsigned int)-1, (unsigned int)-1, 0}};
  s21_smartcalc num2 = {{805306368, (unsigned int)-1167128797, 1626303258, 0}};
  s21_smartcalc res = {{0, 0, 0, 0}};
  //     print_smartcalc(num1);
  // print_smartcalc(num2);
  // printf("\n!!!!!!!!\n");
  int status = s21_div(num1, num2, &res);
  // s21_smartcalc res2 = {{(unsigned int)1431655766, (unsigned int)1431655765,
...
START_TEST(div_18_test) {
  s21_smartcalc num1 = {{1, 1, 1, 1835008}};
  s21_smartcalc num2 = {{0, 0, 0, (unsigned int)-2147483648}};
  s21_smartcalc res = {{0, 0, 0, 0}};
  int status = s21_div(num1, num2, &res);
...
START_TEST(div_20_test) {
  s21_smartcalc num1 = {{1, 0, 0, 1835008}};
  s21_smartcalc num2 = {{4, 0, 0, (unsigned int)-2147483648}};
  s21_smartcalc res = {{0, 0, 0, 0}};
  int status = s21_div(num1, num2, &res);
...
START_TEST(div_big_error) {
  ...
  s21_smartcalc result_our = {{0, 0, 0, 0}};
